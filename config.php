<?php
	$dbServer = 'localhost';
	$dbUsername = 'u392441939_siigred';
	$dbPassword = 'Timo2195';
	$dbDatabase = 'u392441939_siigred';
	$appURI = 'siigred';
	$host = 'localhost';

	$adminConfig = [
		'adminUsername' => "jacaraba",
		'adminPassword' => "\$2y\$10\$IGUeN8DP5BXnadNbhnfNvOkfoUg9mrTqdkQMKxvHJK4kRfV9j1GBi",
