...
*/
	...
	$lookups = [
		'natural' => [
			'VcrIdSol' => [
				'parent_table' => 'solicitudes',
				'parent_pk_field' => 'VcrIdSol',
				'parent_caption' => '`solicitudes`.`VcrSol`',
				'parent_from' => '`solicitudes` ',
				'filterers' => [],
				'custom_query' => '',
			...
			'VcrIdTip' => [
				...
				'parent_pk_field' => 'VcrIdTip',
				'parent_caption' => '`tipo_documento`.`VcrTip`',
			...
			'VcrIdMot' => [
				'parent_table' => 'motivo_visita',
				'parent_pk_field' => 'VcrIdMot',
				'parent_caption' => '`motivo_visita`.`VcrMotVis`',
				'parent_from' => '`motivo_visita` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'VcrIdUbi' => [
				'parent_table' => 'ubicacion',
				'parent_pk_field' => 'VcrIdUbi',
				'parent_caption' => '`ubicacion`.`VcrUbi`',
				'parent_from' => '`ubicacion` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'VcrIdCorr' => [
				...
				'parent_caption' => 'IF(CHAR_LENGTH(`corregimientos`.`VcrCorr`), CONCAT_WS(\'\', `corregimientos`.`VcrCorr`, \' \'), \'\')',
			...
			'VcrIdFen' => [
				'parent_table' => 'fenomenos',
				'parent_pk_field' => 'VcrIdFen',
				'parent_caption' => '`fenomenos`.`VcrFen`',
				'parent_from' => '`fenomenos` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'VcrIdCar' => [
				'parent_table' => 'caracteristicas_evento',
				'parent_pk_field' => 'VcrIdCar',
				'parent_caption' => '`caracteristicas_evento`.`VcrCarFen`',
				'parent_from' => '`caracteristicas_evento` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'VcrIdEdi' => [
				'parent_table' => 'edificacion',
				'parent_pk_field' => 'VcrIdEdi',
				'parent_caption' => '`edificacion`.`VcrEdi`',
				'parent_from' => '`edificacion` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'VcrIdAfe' => [
				'parent_table' => 'afectacion',
				'parent_pk_field' => 'VcrIdAfe',
				'parent_caption' => '`afectacion`.`VcrAfe`',
				'parent_from' => '`afectacion` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'VcrIdMat' => [
				'parent_table' => 'tipo_material',
				'parent_pk_field' => 'VcrIdMat',
				'parent_caption' => '`tipo_material`.`VcrTipMat`',
				'parent_from' => '`tipo_material` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'VcrIdLes' => [
				'parent_table' => 'lesiones',
				'parent_pk_field' => 'VcrIdLes',
				'parent_caption' => '`lesiones`.`VcrLesEst`',
				'parent_from' => '`lesiones` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'VcrIdCap' => [
				'parent_table' => 'capacidad_reducida',
				'parent_pk_field' => 'VcrIdCap',
				'parent_caption' => '`capacidad_reducida`.`VcrCap`',
				'parent_from' => '`capacidad_reducida` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'VcrIdTra1' => [
				'parent_table' => 'dependencias',
				'parent_pk_field' => 'VcrId',
				'parent_caption' => '`dependencias`.`VcrTra`',
				'parent_from' => '`dependencias` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'VcrIdSerP' => [
				'parent_table' => 'servidor_publico',
				'parent_pk_field' => 'VcrIdSerP',
				'parent_caption' => 'IF(CHAR_LENGTH(`servidor_publico`.`VcrSerPub`), CONCAT_WS(\'\', `servidor_publico`.`VcrSerPub`, \' \'), \'\')',
				'parent_from' => '`servidor_publico` LEFT JOIN `procesos` as procesos1 ON `procesos1`.`VcrIdProc`=`servidor_publico`.`VcrIdProc` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'servidor_publico' => [
			'VcrIdProc' => [
				'parent_table' => 'procesos',
				'parent_pk_field' => 'VcrIdProc',
				'parent_caption' => '`procesos`.`VcrNomProc`',
				'parent_from' => '`procesos` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
