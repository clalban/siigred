	...
	*/
	...
	function get_tables_info($skip_authentication = false) {
		...
		$all_tables = [
			/* ['table_name' => [table props assoc array] */   
				'natural' => [
					'Caption' => 'NATURAL',
					'Description' => 'Formato VISITA DE VERIFICACI&#211;N DE CONDICIONES DE RIESGO NATURAL, SOCIO NATURAL Y TECNOL&#211;GICO ',
					'tableIcon' => 'table.gif',
					'group' => $tg[0],
					'homepageShowCount' => 0
				],
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = [
			...
			'natural' => ['NATURAL', 'Formato VISITA DE VERIFICACI&#211;N DE CONDICIONES DE RIESGO NATURAL, SOCIO NATURAL Y TECNOL&#211;GICO ', 'table.gif', 'Registro visitas'],
			...
			$schema = [
				'natural' => [
					'VcrId' => [
						...
						'info' => [
							'caption' => 'VcrId',
							'description' => 'Consecutivo visita de verificaci&#243;n',
						],
					],
					'VcrCodForm' => [
						...
						'info' => [
							'caption' => 'CONSECUTIVO:',
							'description' => 'N&#250;mero del consecutivo asignado en el registro de la Visita de Verificaci&#243;n de Condiciones de Riesgo de Origen Natural, Socio Natural y Tecnol&#243;gico',
						],
					],
					'VcrIdSol' => [
						...
						'info' => [
							...
							'description' => 'Seleccionar el tipo de solicitud relacionado con la visita de verificaci&#243;n que se esta realizando',
						],
					],
					'VcrFecVis' => [
						'appgini' => "DATE NULL",
						'info' => [
							...
							'description' => 'Registrar la fecha en que se realiza la visita y verificaci&#243;n de las condiciones de riesgo',
						],
					],
					'VcrNomAti' => [
					...
					'VcrIdTip' => [
						...
						'info' => [
							...
							'description' => 'Seleccionar el tipo de identificaci&#243;n de la persona que atiende la visita de verificaci&#243;n de condiciones de riesgo de origen natural, socio natural y tecnol&#243;gico',
						],
					],
					'VcrNoIde' => [
						'appgini' => "VARCHAR(10) NOT NULL",
						'info' => [
					...
					'VcrCorEle' => [
						...
						'info' => [
							...
							'description' => 'Registrar el correo electr&#243;nico de la persona que atiende la visita de verificaci&#243;n de condiciones de riesgo de origen natural, socio natural y tecnol&#243;gico.',
						],
					],
					'VcrIdMot' => [
						'appgini' => "VARCHAR(12) NOT NULL",
					...
					'VcrRadSol' => [
						...
						'info' => [
							...
							'description' => 'Registrar el n&#250;mero de radicado de la solicitud del oficio solicitud que ingreso a trav&#233;s del sistema de informaci&#243;n de gesti&#243;n documental.',
						],
					],
					'VcrFecSol' => [
						'appgini' => "DATE NULL",
						'info' => [
							...
							'description' => 'Registrar la fecha de radicado del oficio solicitud que ingreso a trav&#233;s del sistema de informaci&#243;n de gesti&#243;n documental.',
						],
					],
					'VcrObsDat' => [
						'appgini' => "LONGTEXT NULL",
						'info' => [
							'caption' => 'OBSERVACIONES DATOS:',
							'description' => 'Registrar las observaciones que hayan relacionados con los datos de la visita de verificaci&#243;n',
						],
					],
					'VcrIdUbi' => [
						'appgini' => "BIGINT NOT NULL",
						'info' => [
							'caption' => 'UBICACION:',
							'description' => 'Seleccionar la zona de la visita',
						],
					],
					'VcrDir' => [
					...
					'VcrObsUbi' => [
						'appgini' => "LONGTEXT NULL",
						'info' => [
							'caption' => 'OBSERVACIONES UBICACION:',
							'description' => 'Registrar las observaciones relacionadas con la ubicaci&#243;n  del lugar donde se realiza la visita de verificaci&#243;n.',
						],
					],
					'VcrIdFen' => [
						'appgini' => "VARCHAR(12) NOT NULL",
					...
					'VcrDet' => [
						...
						'info' => [
							'caption' => 'DETONANTE',
							'description' => 'Registrar el detonante  (En  caso que no aplique colocar N/A)',
						],
					],
					'VcrIdCar' => [
						'appgini' => "VARCHAR(12) NOT NULL",
					...
					'VcrOtr' => [
						'appgini' => "VARCHAR(40) NULL",
						'info' => [
							'caption' => 'OTRAS CARACTERISTICAS DEL EVENTO:',
							'description' => 'Registrar si existen otras caracteristicas del evento asociadas a la visita de verificaci&#243;n',
						],
					],
					'VcrDesEve' => [
						...
						'info' => [
							...
							'description' => 'Registrar una descripci&#243;n resumida del evento relacionado con la visita de verificaci&#243;n',
						],
					],
					'VcrIdEdi' => [
						'appgini' => "VARCHAR(12) NULL",
						'info' => [
							...
							'description' => 'Seleccionar el tipo de edificaci&#243;n asociado con la visita de verificaci&#243;n',
						],
					],
					'VcrNoPis' => [
						'appgini' => "INT(2) NULL",
						'info' => [
							'caption' => 'N&#218;MERO DE PISOS:',
							'description' => 'Digite el n&#250;mero de pisos de la edificaci&#243;n asociada con la visita de verificaci&#243;n.',
						],
					],
					'VcrObrCiv' => [
						'appgini' => "VARCHAR(20) NULL",
						'info' => [
							'caption' => 'OBRA CIVIL:',
							'description' => 'Registrar el estado de la  obra civil de la edificaci&#243;n asociada con la visita de verificaci&#243;n.',
						],
					],
					'VcrEstEdi' => [
						'appgini' => "VARCHAR(40) NULL",
						'info' => [
							'caption' => 'ESTADO VISUAL:',
							'description' => 'Seleccione de acuerdo al estado en que se encuentra la edificaci&#243;n y obra civil asociadas con la visita de verificaci&#243;n.',
						],
					],
					'VcrIdAfe' => [
						'appgini' => "VARCHAR(12) NULL",
						'info' => [
							'caption' => 'AFECTACI&#211;N:',
							'description' => 'Seleccione el tipo de afectaci&#243;n de la edificaci&#243;n asociada a la visita de verificaci&#243;n.',
						],
					],
					'VcrObsEst' => [
						'appgini' => "LONGTEXT NULL",
						'info' => [
							'caption' => 'OBSERVACIONES AFECTACION:',
							'description' => 'Registre las observaciones que tenga sobre la afectaci&#243;n de la edificaci&#243;n',
						],
					],
					'VcrDanGrav' => [
						'appgini' => "VARCHAR(4) NULL",
						'info' => [
							'caption' => 'DA&#209;OS GRAVES:',
							'description' => 'Seleccione si hay posibilidad de da&#241;os graves en la edificaci&#243;n asociada con la visita de verificaci&#243;n',
						],
					],
					'VcrAnoCon' => [
						'appgini' => "VARCHAR(5) NULL",
						'info' => [
							'caption' => 'A&#209;OS DE CONSTRUCCION:',
							'description' => 'Registrar el numero de a&#241;os aproximado de construcci&#243;n de la  edificaci&#243;n asociada con la visita de verificaci&#243;n',
						],
					],
					'VcrIdMat' => [
						...
						'info' => [
							...
							'description' => 'Registrar el tipo de material de la  edificaci&#243;n asociada con la visita de verificaci&#243;n',
						],
					],
					'VcrIdLes' => [
						'appgini' => "VARCHAR(12) NULL",
						'info' => [
							'caption' => 'LESIONES EN LA ESTRUCTURA:',
							'description' => 'Seleccionar  el tipo de lesi&#243;n en la estructura de la  edificaci&#243;n asociada con la visita de verificaci&#243;n',
						],
					],
					'VcrAyuHum' => [
					...
					'VcrConAyu' => [
						'appgini' => "VARCHAR(20) NULL",
						'info' => [
							'caption' => 'CONSECUTIVO AYUDA:',
							'description' => 'Ingrese el n&#250;mero de consecutivo asignado en el formato de registro de entrega de ayuda humanitaria',
						],
					],
					'VcrObs' => [
						'appgini' => "LONGTEXT NULL",
						'info' => [
							'caption' => 'OBSERVACIONES AYUDA',
							'description' => 'Registrar las observaciones relacionadas con la ayuda humanitaria entregada en la visita de verificaci&#243;n',
						],
					],
					'VcrCapRed' => [
						...
						'info' => [
							'caption' => 'CAPACIDAD REDUCIDA:',
							'description' => 'Registrar si existen personas con capacidad reducida ',
						],
					],
					'VcrIdCap' => [
						'appgini' => "VARCHAR(12) NULL",
						'info' => [
							'caption' => 'TIPO CAPACIDAD REDUCIDA:',
							'description' => 'Seleccionar el tipo de capacidad reducida que se presenta',
						],
					],
					'VcrOtrCap' => [
						'appgini' => "LONGTEXT NULL",
						'info' => [
							'caption' => 'OTRA CAPACIDAD REDUCIDA:',
							'description' => 'Registrar si existe otro tipo de capacidad reducida diferente a la que se encuentra en el listado',
						],
					],
					'VcrInf0a5F' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL PRIMERA INFANCIA - FEMENINO:',
							'description' => 'Registrar el numero de personas de primera infancia (cantidad de 0-5 a&#241;os de edad) genero femenino asociadas con la visita de verificaci&#237;n',
						],
					],
					'VcrInf0a5M' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL PRIMERA INFANCIA MASCULINO:',
							'description' => 'Registrar el numero de personas de primera infancia (cantidad de 0-5 a&#241;os de edad) genero masculino asociadas con la visita de verificaci&#243;n',
						],
					],
					'VcrInf5a12F' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL NI&#209;AS FEMENINO:',
							'description' => 'Registrar el numero de personas de ni&#241;os (cantidad de 5-12 a&#241;os de edad) genero Femenino asociados con la visita de verificaci&#243;n',
						],
					],
					'VcrInf5a12M' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL NI&#209;OS:',
							'description' => 'Registrar el numero de personas de ni&#241;os ( 5-12 a&#241;os de edad) genero  Masculino asociados con la visita de verificaci&#243;n',
						],
					],
					'VcrAd12a18F' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL ADOLESCENTES FEMENINO:',
							'description' => 'Registrar el numero de personas de adolescentes (12-18 a&#241;os de edad) genero  Femenino asociados con  la visita de verificaci&#243;n.',
						],
					],
					'VcrAd12a18M' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL ADOLESCENTES MASCULINO:',
							'description' => 'Registrar el numero de personas de adolescentes (12-18 a&#241;os de edad) genero  masculino asociados con la visita de verificaci&#243;n.',
						],
					],
					'VcrAd18a28F' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL JOVEN ADULTO FEMENINO:',
							'description' => 'Registrar el numero de personas de joven adulto (18-28 a&#241;os de edad) genero femenino asociado con la visita de verificaci&#243;n',
						],
					],
					'VcrAd18a28M' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL JOVEN ADULTO MASCULINO:',
							'description' => 'Registrar el numero de personas de joven adulto (18-28 a&#241;os de edad) genero masculino asociado con la visita de verificaci&#243;n.',
						],
					],
					'VcrAd28a60F' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL ADULTO FEMENINO:',
							'description' => 'Registrar el numero de personas de adulto (cantidad de 28-60 a&#241;os de edad) genero femenino asociado con la visita de verificaci&#243;n.',
						],
					],
					'VcrAd28a60M' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL ADULTO MASCULINO:',
							'description' => 'Registrar el numero de personas de adulto (cantidad de 28-60 a&#241;os de edad) genero masculino asociado con la visita de verificaci&#243;n.',
						],
					],
					'VcrAdMay60F' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL ADULTO MAYOR FEMENINO:',
							'description' => 'Registrar el numero de personas de adulto mayor (cantidad de mas de 60 a&#241;os de edad) genero femenino asociado con la visita de verificaci&#243;n.',
						],
					],
					'VcrAdMay60M' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CICLO VITAL ADULTO MAYOR MASCULINO:',
							'description' => 'Registrar el numero de personas de adulto mayor (cantidad de mas de 60 a&#241;os de edad) genero masculino asociados con la visita de verificaci&#243;n.',
						],
					],
					'VcrAfr' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'AFROCOLOMBIANAS:',
							'description' => 'Registrar el numero de personas afrocolombianas asociados con la visita de verificaci&#243;n.',
						],
					],
					'VcrPal' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'PALENQUERAS:',
							'description' => 'Registrar el numero de personas palenqueras  asociados con la visita de verificaci&#243;n.',
						],
					],
					'VcrInd' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'IND&#205;GENAS:',
							'description' => 'Registrar el numero de personas indigenas asociados con la visita de verificaci&#243;n.',
						],
					],
					'VcrCau' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'CAUCACICAS:',
							'description' => 'Registrar el numero de personas caucacicas asociados con la visita de verificaci&#243;n.',
						],
					],
					'VcrGit' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'GITANAS:',
							'description' => 'Registrar el numero de personas gitanas asociados con la visita de verificaci&#243;n.',
						],
					],
					'VcrMes' => [
						'appgini' => "INT NULL",
						'info' => [
							'caption' => 'MESTIZAS:',
							'description' => 'Registrar el numero de personas mestizas asociados con la visita de verificaci&#243;n.',
						],
					],
					'VcrOtrPer' => [
						'appgini' => "VARCHAR(40) NULL",
						'info' => [
							'caption' => 'OTROS PERTENENCIA ETNICA:',
							'description' => 'Registrar el numero de personas con otra pertenencia etnica y cual es.',
						],
					],
					'VcrPerNsNr' => [
						'appgini' => "VARCHAR(2) NULL",
						'info' => [
							'caption' => 'PERTENENCIA ETNICA NS/NR:',
							'description' => 'Ingresar si no sabe o no responde si existe pertenencia etnica',
						],
					],
					'VcrTraCas' => [
						...
						'info' => [
							...
							'description' => 'Registrar si se requiere realizar traslado del caso a otras dependencias',
						],
					],
					'VcrIdTra1' => [
						'appgini' => "INT UNSIGNED NULL",
						'info' => [
							'caption' => 'ORGANISMO O ENTIDAD 1:',
							'description' => 'Registrar si se requiere intervenci&#243;n de otras dependencias, el organismo o Entidad a la que se traslada el reporte para hacer <br>seguimiento <br>',
						],
					],
					'VcrdTra2' => [
						'appgini' => "INT UNSIGNED NULL",
						'info' => [
							'caption' => 'ORGANISMO O ENTIDAD 2:',
							'description' => 'Registrar si se requiere intervenci&#243;n de otras dependencias, el organismo o Entidad a la que se traslada el reporte para hacer <br>seguimiento <br>',
						],
					],
					'VcrIdTra3' => [
					...
					'VcrRecLin' => [
						'appgini' => "VARCHAR(10) NOT NULL",
						'info' => [
							'caption' => 'RECOMENDACION LINEA EMERGENCIA:',
							'description' => 'Recuerde las l&#237;neas de emergencia: Bomberos- 119, Cruz Roja- 132, Defensa Civil- 144 y Gases de Occidente- 164',
						],
					],
					'VcrRecLey' => [
						'appgini' => "VARCHAR(10) NOT NULL",
						'info' => [
							'caption' => 'RECOMENDACION LEY 1523:',
							'description' => 'La ley 1523 del 24 de abril de 2012, "Por la cual se adopta la pol&#237;tica nacional de gesti&#243;n del riesgo de desastres y se establece el sistema nacional de gesti&#243;n del riesgo de <br>desastres y se dictan otras disposiciones en su art&#237;culo 2&#176; de la responsabilidad". ',
						],
					],
					'VcrRecPre' => [
						'appgini' => "VARCHAR(10) NOT NULL",
						'info' => [
							'caption' => 'RECOMENDACION PRINCIPIO PRECAUCION:',
							'description' => 'Amparados en la ley 1523 de 2012 art&#237;culo 3&#176;, Principio de precauci&#243;n, es nuestro deber legal informarle que cuando exista la posibilidad de da&#241;os graves o irreversibles a las <br>vidas y/o a los bienes materiales, se debe evacuar de manera preventiva.',
						],
					],
					'VcrRecAut' => [
						'appgini' => "VARCHAR(10) NOT NULL",
						'info' => [
							'caption' => 'RECOMENDACIONES PRINCIPIO AUTOCONSERVACION:',
							'description' => 'Amparado en la ley 1523 de 2012 art&#237;culo 3&#176;, Principio de autoconservaci&#243;n, es nuestro deber legal solicitarle que de forma inmediata evacue su vivienda, con el fin de conservar <br>su vida y la de su familia.',
						],
					],
					'VcrDatPer' => [
						'appgini' => "VARCHAR(2) NOT NULL",
						'info' => [
							...
							'description' => 'Autorizo ingresar mis datos personales en la base de datos de la Secretar&#237;a de Gesti&#243;n del Riesgo de Emergencias y Desastres Distrito Especial de Cali - (Ley 1581 de 2012 "Por <br>la cual se dicta disposiciones generales para la protecci&#243;n de datos personales)<br>',
						],
					],
					'VcrUsoIma' => [
						'appgini' => "VARCHAR(2) NOT NULL",
						'info' => [
							'caption' => 'USO DE IMAGENES:',
							'description' => 'Autorizo el uso de imagen(es) que se otorga en el marco establecido en las leyes 23 de 1982, 44 de 1993, 1581 de 2012 (Ley de Protecci&#243;n de Datos Personales) y 1915 de 2018 y <br>el Decreto Nacional 1074 de 2015, y por termino durante el cual la Secretar&#237;a de Gesti&#243;n del Riesgo de Emergencias y Desastres sea titular de los derechos sobre el material <br>audiovisual referido.<br>',
						],
					],
					'VcrUsoDat' => [
						'appgini' => "VARCHAR(2) NOT NULL",
						'info' => [
							'caption' => 'USO DATOS PERSONALES:',
							'description' => 'He sido informado(a) previamente respecto del uso que se le dar&#225; a mis datos personales y su finalidad. ',
						],
					],
					'VcrAutCor' => [
						'appgini' => "VARCHAR(2) NOT NULL",
						'info' => [
							'caption' => 'AUTORIZACION CORREO ELECTR&#211;NICO:',
							'description' => 'A trav&#233;s de este formato autorizo para que sean enviados v&#237;a correo electr&#243;nico la informaci&#243;n y datos que resulten de est&#225; visita ',
						],
					],
					'VcrIdSerP' => [
						...
						'info' => [
							...
							'description' => ' informaci&#243;n de la persona (funcionario/contratista), que se<br>desplaza al sitio y realiza la visita de de verificaci&#243;n de condiciones de riesgo de origen natural, socio natural y<br>tecnol&#243;gico.',
						],
					],
					'VcrIma' => [
						'appgini' => "VARCHAR(40) NULL",
						'info' => [
							'caption' => 'FOTO',
							'description' => 'Ingrese imagen asociada con la visita de verificaci&#243;n, formatos jpg, jpeg, gif, png o webp',
						],
					],
					'VcrVideo' => [
						'appgini' => "VARCHAR(40) NULL",
						'info' => [
							'caption' => 'VIDEO',
							'description' => 'Adjunte video de la visita de verificaci&#243;n ',
						],
					],
					'VcrDoc' => [
						'appgini' => "VARCHAR(40) NULL",
						'info' => [
							'caption' => 'DOCUMENTO',
							'description' => 'Adjunte documento asociado con la visita de verificaci&#243;n en formato pdf',
						],
					],
				],
				'tipo_documento' => [
	...
	function get_parent_tables($table) {
		...
		$parents = [
			'natural' => [
				...
				'dependencias' => ['VcrIdTra4', 'VcrIdTra3', 'VcrdTra2', 'VcrIdTra1'],
		...
		*/
		$lookupQuery = [
			'natural' => [
				...
				'VcrIdTip' => 'SELECT `tipo_documento`.`VcrIdTip`, `tipo_documento`.`VcrTip` FROM `tipo_documento` ORDER BY 2',
				'VcrIdMot' => 'SELECT `motivo_visita`.`VcrIdMot`, `motivo_visita`.`VcrMotVis` FROM `motivo_visita` ORDER BY 2',
				'VcrIdUbi' => 'SELECT `ubicacion`.`VcrIdUbi`, `ubicacion`.`VcrUbi` FROM `ubicacion` ORDER BY 2',
				...
				'VcrIdEdi' => 'SELECT `edificacion`.`VcrIdEdi`, `edificacion`.`VcrEdi` FROM `edificacion` ORDER BY 2',
				'VcrIdAfe' => 'SELECT `afectacion`.`VcrIdAfe`, `afectacion`.`VcrAfe` FROM `afectacion` ORDER BY 2',
				'VcrIdMat' => 'SELECT `tipo_material`.`VcrIdMat`, `tipo_material`.`VcrTipMat` FROM `tipo_material` ORDER BY 2',
				'VcrIdLes' => 'SELECT `lesiones`.`VcrIdLes`, `lesiones`.`VcrLesEst` FROM `lesiones` ORDER BY 2',
				'VcrIdCap' => 'SELECT `capacidad_reducida`.`VcrIdCap`, `capacidad_reducida`.`VcrCap` FROM `capacidad_reducida` ORDER BY 2',
				'VcrIdTra1' => 'SELECT `dependencias`.`VcrId`, `dependencias`.`VcrTra` FROM `dependencias` ORDER BY 2',
				'VcrdTra2' => 'SELECT `dependencias`.`VcrId`, `dependencias`.`VcrTra` FROM `dependencias` ORDER BY 2',
