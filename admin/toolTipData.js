...
// natural table
natural_addTip=["",spacer+"This option allows all members of the group to add records to the 'NATURAL' table. A member who adds a record to the table becomes the 'owner' of that record."];

natural_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'NATURAL' table."];
natural_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'NATURAL' table."];
natural_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'NATURAL' table."];
natural_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'NATURAL' table."];

natural_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'NATURAL' table."];
natural_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'NATURAL' table."];
natural_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'NATURAL' table."];
natural_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'NATURAL' table, regardless of their owner."];

natural_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'NATURAL' table."];
natural_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'NATURAL' table."];
natural_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'NATURAL' table."];
natural_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'NATURAL' table."];
